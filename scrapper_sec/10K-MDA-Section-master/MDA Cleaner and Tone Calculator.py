...
filepath=root_path+"/downloaded_mda/"



#This is the filepath of the word dictionary files.  This must be changed to your respective filepath.
filepath2=root_path+"/Word_Dictionaries"

#if doesnt exist, create an output  folder
if not os.path.exists(root_path+"cleaned_mda"):
    os.makedirs(root_path+"cleaned_mda")
...
filepath3=root_path+"/cleaned_mda"
