...
path_code = path_env+"/scrapper_sec/"
...
file_name_pickle  = "../pickles/filtered_index DEF 14A.pkl"
...
#    text_file.close()
    ...
    ceo_name_list.append(str(row['SDCDEALNUMBER']))
    ceo_name_list.append(str(url_html))            
    ceo_name_list.append(ceo_target)
    ceo_name_list.append(str(name_file_output2))
    
#    with open(path_output+'index.csv', 'a') as writeFile:
...
#    r1 = re.search(r"(?:[a-zA-Z'-]+[^a-zA-Z'-]+){0,5} age (?:[^a-zA-Z'-]+[a-zA-Z'-]+){0,5}", clean_text)
...
#    r1 = re.findall(r"(?:[a-zA-Z'-]+[^a-zA-Z'-]+){0,5} age (?:[^a-zA-Z'-]+[a-zA-Z'-]+){0,3}", clean_text)
    ...
    r1 = re.findall(r"(?:[a-zA-Z'-]+[^a-zA-Z'-]+){0,0}"+ ceo_target+ "(?:[^a-zA-Z'-]+[a-zA-Z'-]+){0,5}", clean_text)
    ...
    if r1:
        ...
        for chunk in r1:
            ...
            if (ceo_target in chunk) and ("age " in chunk):
                ...
                ceo_name_list.append(str(url_html))            
                ceo_name_list.append(ceo_target)
                ceo_name_list.append(str(name_file_output))
